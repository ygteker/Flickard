        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                Group {
                    ...
                    Text("By downloading, installing, or using Flickard (\"the App\"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the App.")
                    
                    SectionHeader(title: "Open Source Software")
                    Text("Flickard is free and open-source software. The source code is available for inspection, modification, and contribution. While the app binary is distributed through the App Store, you're free to:")
                    ...
                    Link(destination: URL(string: "https://github.com/ygteker/flickard")!) {
                        HStack {
                    ...
                    Text("You are free to use Flickard for personal, educational, or commercial purposes. The app is provided under an open-source license—please refer to the project repository for specific license terms.")
                    
                    SectionHeader(title: "Permitted Use")
                    Text("You may use Flickard to:")
                ...
                Group {
                    ...
                    Text("The App's source code is open source and licensed accordingly (see project repository for details). While you're free to use, modify, and distribute the code according to the license, the \"Flickard\" name and any original design elements remain attributed to the original author.")
                ...
                Group {
                    ...
                    Text("By using Flickard, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.")
                }
                
                Divider()
                
                Text("Thank you for using Flickard!")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
                    .padding(.top)
            }
