        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                Group {
                    ...
                    Text("Flickard is committed to protecting your privacy. This Privacy Policy explains how we handle your information when you use our flashcard application.")
                    
                    SectionHeader(title: "Data Collection")
                    Text("Flickard is designed with privacy as a priority. We do not collect, transmit, or store any of your personal information on external servers.")
                ...
                Group {
                    ...
                    Text("Flickard does not use any third-party analytics, advertising, or tracking services. Your data stays on your device.")
                    ...
                    Text("Flickard does not knowingly collect any information from children. The app is designed to be safe for users of all ages.")
                ...
                Text("By using Flickard, you agree to this Privacy Policy.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
                    .padding(.top)
            }
